(function() {
    ...
    function getPreviewData() {
        ...
        const verificationOrigin = window.location.protocol === 'https:' && !/^(localhost|127\.0\.0\.1)$/.test(window.location.hostname) ? window.location.origin : 'https://shaivikagroups.in';
