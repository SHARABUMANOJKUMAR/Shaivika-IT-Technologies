...
function initializeInvoiceManager() {
    ...
    function renderCreateInvoiceForm(uuid = null) {
        ...
        if (uuid) {
            ...
            if (inv) {
                document.getElementById('inv-form-uuid').value = inv.invoice_uuid;
                ...
                document.getElementById('inv-form-state').value = inv.state_code || 'AP';
                ...
                document.getElementById('inv-flat-summary').value = inv.notes || '';
                
                const customer = InvoiceDB.getCustomerById(inv.customer_id);
                if (customer) {
                    document.getElementById('inv-flat-name').value = customer.name || '';
                    document.getElementById('inv-flat-phone').value = customer.phone || '';
                    document.getElementById('inv-flat-email').value = customer.email || '';
                }
                ...
                if (inv.items && inv.items.length > 0) {
                    ...
                    document.getElementById('inv-flat-price').value = item.rate || 0;
                    document.getElementById('inv-flat-gst').value = item.taxRate || 0;
                }
            ...
            document.getElementById('inv-form-uuid').value = '';
            document.getElementById('inv-form-id').value = '';
            document.getElementById('inv-form-date').value = today;
            document.getElementById('inv-form-state').value = 'AP';
            ...
            document.getElementById('inv-flat-summary').value = '';
            document.getElementById('inv-flat-name').value = '';
            document.getElementById('inv-flat-phone').value = '';
            document.getElementById('inv-flat-email').value = '';
            document.getElementById('inv-flat-price').value = 0;
            document.getElementById('inv-flat-gst').value = InvoiceDB.getSettings().defaultTaxRate || 18;
    ...
    window.saveInvoiceForm = function(targetStatus = 'DRAFT') {
        ...
        if (!document.getElementById('inv-form-uuid').value && saved) {
             document.getElementById('inv-form-uuid').value = saved.invoice_uuid;
             document.getElementById('inv-form-id').value = saved.invoice_number;
        }
